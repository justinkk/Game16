...
public class PlayerController : MonoBehaviour {
    ...
    private static readonly float[] DEFAULT_STATS = { 12, 16, 1.6f, 0.5f }; //Default base stats
    ...
    private static readonly float[] BOOST_PER_STAT = { 0.2f, .3f, 0.2f, 0.15f }; //How much each stat changes per stat level
    private static readonly float[] ROPELESS_PENALTY = { 0.4f, 0.2f, 0.9f, 1.0f }; //How much each stat is punished for being ropeless
